...
Widget graphChart(context, ChartGraphData, isLoadedList) {
  MediaQueryData data = MediaQuery.of(context);
    return
      //isLoadedList == false ? CircularProgressIndicator(backgroundColor: Colors.lightBlueAccent,) :
      Padding(
  ...
  //   _ChartData(DateTime(2004), 320, const Color.fromRGBO(248, 184, 131, 1)),
  ...
  //   _ChartData(DateTime(2012), 300, const Color.fromRGBO(0, 189, 174, 1)),
  ...
  //   _ChartData(DateTime(2015), 490, const Color.fromRGBO(248, 184, 131, 1)),
  ...
  //   _ChartData(DateTime(2020), 590, const Color.fromRGBO(248, 184, 131, 1)),
  // ];
  // return <LineSeries<_ChartData, DateTime>>[
  //   LineSeries<_ChartData, DateTime>(
  //       enableTooltip: true,
